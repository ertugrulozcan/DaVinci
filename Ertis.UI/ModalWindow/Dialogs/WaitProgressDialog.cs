...
namespace Ertis.Shared.ModalWindow.Dialogs
{
    class WaitProgressDialog : DialogBase, IProgressDialog
    {
        ...
        private WaitProgressDialog(IDialogHost dialogHost, DialogMode dialogMode, bool showWaitAnimation, Dispatcher dispatcher) : base(dialogHost, dialogMode, dispatcher)
        {
        ...
        public string Message
        {
            get
            {
                ...
                InvokeUICall(() => text = _waitProgressDialogControl.DisplayText);
                return text;
            }
            set
            {
                InvokeUICall(() => _waitProgressDialogControl.DisplayText = value);
            }
        }
        ...
        private readonly ManualResetEvent _beginWork = new ManualResetEvent(false);
        ...
        public int Progress
        {
            ...
            {
                var progress = 0;
                InvokeUICall(() => progress = _waitProgressDialogControl.Progress);
                return progress;
            }
            set
            {
                InvokeUICall(() => _waitProgressDialogControl.Progress = value);
            }
        }
