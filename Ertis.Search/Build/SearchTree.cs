...
namespace Ertis.Search.Build
{
    public class SearchTree
    {
        ...
        /// Constructor
        /// </summary>
        public SearchTree(List<KeyValuePair<string, object>> source)
        {
            this.Root = Node.CreateWithSource(this.RootKey, source);
        }
        ...
        internal void AddItems(List<KeyValuePair<string, object>> addedItems)
        {
            if (this.Root == null)
                return;
        ...
        internal void RemoveItems(List<KeyValuePair<string, object>> removedItems)
        {
            if (this.Root == null)
                return;
